let gameboard = {
    ...
    signalHit: function(){
        ...
        this.board.style.borderColor = '#F9E3BD'
        setTimeout(() => {this.board.style.borderColor = '#E67BF7'}, 200)
    },
    scoreAnimation: function(board){
        // Flashes a scoreboard green when a point is scored or a match ends.
        this.scoreboards[board].style.backgroundColor = '#36ce66'
        this.scoreboards[board].style.transform = 'scale(1.2)'
        setTimeout(() => {
            this.scoreboards[board].style.backgroundColor = '#F9E3BD'
